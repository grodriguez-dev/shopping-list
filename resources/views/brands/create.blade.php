                ...
                <div class="p-6 bg-white border-b border-gray-200">
                  ...
                  <div class="relative py-3 w-11/12 max-w-xl sm:mx-auto">
                    <div class="relative p-8 bg-white shadow-sm sm:rounded-xl">
                      <form class="w-full" action="{{route('brands.store')}}" method="POST">
                        @csrf
                        <div class="mb-5 relative">
                          <input type="text" id="title" class="peer pt-8 border border-gray-200 focus:outline-none rounded-md focus:border-gray-500 focus:shadow-sm w-full p-3 h-16 placeholder-transparent" name="title" required="" />
                        ...
                        <a href="{{route('brands.index')}}" class="bg-blue-600 text-white p-3 rounded-md">Back</a>
                      </form>
                    </div>
                  </div>
                </div>
